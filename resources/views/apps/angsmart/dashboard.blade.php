<x-angsmart-layout pageTitle="Dashboard">
    <x-angsmart.page-header
        title="Ringkasan &amp; Akses Cepat"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        <x-angsmart.stat-card label="Total Pasien" :value="$stats['total']" tone="primary" stagger="animate-delay-100">
            <x-slot:icon>
        ...
        <x-angsmart.stat-card label="Dalam Asuhan" :value="$stats['dalam_asuhan']" tone="success" stagger="animate-delay-200">
            <x-slot:icon>
        ...
        <x-angsmart.stat-card label="Menunggu Tindakan" :value="$stats['menunggu_tindakan']" tone="warning" stagger="animate-delay-300">
            <x-slot:icon>
                <svg class="h-full w-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            </x-slot:icon>
        </x-angsmart.stat-card>
        <x-angsmart.stat-card label="Perlu Handover" :value="$stats['perlu_handover']" tone="emergency" stagger="animate-delay-400">
            <x-slot:icon>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
        <div class="xl:col-span-2 bg-rs-surface border border-rs-border rounded-2xl p-6 shadow-sm angsmart-surface animate-element animate-delay-300">
        ...
        <x-angsmart.quick-access class="animate-element animate-delay-400" />
    </div>

    <div class="bg-rs-surface border border-rs-border rounded-2xl shadow-sm overflow-hidden angsmart-surface animate-element animate-delay-400">
                        ...
                        <tr class="hover:bg-rs-background/80">
                            ...
                            <td class="px-4 py-3">
                                <a
                                    ...
                                    class="text-rs-primary font-semibold hover:text-rs-primary-dark transition-colors duration-200"
                                >Lihat</a>
                            </td>
                        </tr>
                    @endforeach
