...
@php
    $cardClasses = match ($icon) {
        'surgicon' => 'bg-emerald-50 border-2 border-emerald-400 hover:border-emerald-500 hover:bg-emerald-100/60',
