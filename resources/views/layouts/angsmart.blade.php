                    ...
                    >
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                @if ($pageTitle)
                                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-rs-primary truncate">
                                        {{ $pageTitle }}
                                    </h1>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center gap-3 sm:justify-end shrink-0">
                                <div class="text-sm text-rs-text-secondary text-left sm:text-right">
                                    ...
                                    <p class="mt-0.5 text-xs sm:text-sm">Perawat | Shift Pagi (07.00 – 14.00)</p>
                                </div>
                                <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-rs-primary text-sm font-bold text-white">
