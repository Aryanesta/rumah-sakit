...
- **SHOULD** use class-based components when the component needs DI, computed helpers, or conditional logic. **PREFER** anonymous components for simple markup wrappers — see `components.md`.
