...
> Refines `testing.md` for this directory. Anything that needs the app booted is a Feature test — see `feature.md`.
...
- Naming / layering / structure → **Architecture** (`architecture.md`).
