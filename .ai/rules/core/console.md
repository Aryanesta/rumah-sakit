...
Scheduling rules live in `../http/routes.md` — see the "Task scheduling" section. Schedules are defined in `routes/console.php` via the `Schedule` facade, not in `app/Console/Kernel.php` (removed from the modern skeleton).
