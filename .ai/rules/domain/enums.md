...
- **MUST** cast model columns to the enum in the model's `casts()` — see `../database/models.md`.
...
- **MUST** return translated strings from user-facing `label()` (and similar) methods via `__()` — see `../core/app.md`.
