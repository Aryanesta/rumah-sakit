...
- **MUST** bind the interface to its implementation in a Service Provider's `register()` — see `../core/providers.md`. Use `bind` for per-resolution, `singleton` for a shared instance.
